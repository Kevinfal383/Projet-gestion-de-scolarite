...
<head>
	...
	<link rel="stylesheet" media="screen" type="text/css" title="Essai" href="nouveau.css" />
</head>
<body>
<div class="ombre"></div>
...
<article>
        <div class="cool">
            <div class="mySlides">
                <img id="tete" src="entete.png" alt="">
            </div>
            <div class="mySlides">
                <img id="bg" src="background.JPG" alt="">
            </div>
    ...
    <div class="big_block">
        <div class="block">
            <div class="unique">
                <p><a href="#">ETUDIANTS</a></p>
            </div>
            <div class="unique">
                <p><a href="afficher_prof.php">ENSEIGNANTS</a></p>
            </div>
            <div class="unique">
                <p><a href="affiche_classe.php">CLASSES</a></p>
            </div>
        </div>
        <div class="block">
            <div class="petit">
                <p><a href="afficher_stage.php">STAGES</a></p>
            </div>
            <div class="petit" id="matiere">
                <p><a href="">MATIERES</a></p>
            </div>
            <div class="petit" id="diplome">
                <p><a href="type_diplome.php">DIPLOMES</a></p>
            </div>
        </div>
        <div>
            <div class="small">
                <p><a href="afficher_enseign.php">ENSEIGNEMENTS</a></p>
            </div>
        </div>
    </div>
...
<div class="pied"><br/><center>&reg; 2010 Ecole superieure de technologie de Berrechid. Gestion de scolarite</center></div>